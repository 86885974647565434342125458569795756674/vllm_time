...
class Scheduler:
    ...
    def __init__(
        ...
        """cyy"""
        self.scheduler_config.max_num_batched_tokens = 67108864
        self.scheduler_config.max_num_seqs = 32768
        """cyy"""
    ...
    def _schedule(self) -> SchedulerOutputs:
        ...
        # groups to preempt.
        self.running = self.policy.sort_by_priority(now, self.running) ##从早到晚排

        # Reserve new token slots for the running sequence groups.
        running: List[SequenceGroup] = []
        preempted: List[SequenceGroup] = []
        while self.running:
            seq_group = self.running.pop(0) ##最早的
            while not self.block_manager.can_append_slot(seq_group): ##没有物理块可以分配
                if self.running:
    ...
    def schedule(self) -> Tuple[List[SequenceGroupMetadata], SchedulerOutputs]:
        ...
        # """cyy"""
        # print("gpu block",self.block_manager.get_num_free_gpu_blocks())
        # """cyy"""
