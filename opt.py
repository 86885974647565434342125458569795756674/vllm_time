...
class OPTAttention(nn.Module):
    ...
    def forward(
        ...
        if cyy_start:
            ...
            print("qkv_proj", start.elapsed_time(end))
        """cyy"""
        ...
        if cyy_start:
            ...
            torch.cuda.synchronize() 
            print("attn", start.elapsed_time(end))
        """cyy"""
...
class OPTDecoder(nn.Module):
    ...
    def forward(
        ...
        """cyy"""
        global cyy_count, cyy_start
        if cyy_count == 1 or cyy_count == 3:
            cyy_start = True
            print("****************************************************************")
            print("count",cyy_count)
        else:
            cyy_start = False
        if cyy_count == 4:
            import sys
            sys.exit(0)
        cyy_count = cyy_count + 1
        """cyy"""
